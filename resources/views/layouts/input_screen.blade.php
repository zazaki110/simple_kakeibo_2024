...
<header class="header_main"><div class="header_menu"><a class="tukibetu" href="http://127.0.0.1:8000/tarukame_totalling" >月別データ</a>
    ...
    <a class="nyuryoku" href="{{url('/register_member',)}}" >入力画面</a><a class="nenbetu" href="http://127.0.0.1:8000/tarukame_nenbetu">年別データ</a><div class="user_name_touroku">こんにちは&nbsp&nbsp{{$UserName}}さん</div>
